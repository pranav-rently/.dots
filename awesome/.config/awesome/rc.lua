...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "XF86AudioMute", function()
        awful.util.spawn("amixer -D pulse sset Master toggle-mute")
    end),
    ...
    -- Brightness controls using Brillo
    awful.key({ }, "XF86MonBrightnessUp", function()
        awful.util.spawn("brillo -A +5") end),
    awful.key({ }, "XF86MonBrightnessDown", function()
        awful.util.spawn("brillo -U +5") end),

    -- Pavucontrol
    awful.key({ modkey }, "v", function()
        awful.util.spawn("pavucontrol") end, {description = "pavucontrol", group = "launcher"}),

    -- Brave browser
    awful.key({ modkey }, "b", function()
        awful.util.spawn("brave-browser") end, {description = "brave browser", group = "launcher"}),

    -- File manager
    awful.key({ modkey }, "p", function()
        awful.util.spawn("pcmanfm") end, {description = "file manager", group = "launcher"})
)
